...
def register():
    ...
    try:
        ...
        # send_verification_email(user.email, user.public_id)
...
def update_profile():
    ...
    allowed_fields = ['display_name', 'bio', 'age_range', 'preferred_anonymity', 
                     'crisis_contact_number', 'emergency_contact_name', 'emergency_contact_number']
...
# backend/app/blueprints/posts/__init__.py
from flask import Blueprint

bp = Blueprint('posts', __name__)

from app.blueprints.posts import route